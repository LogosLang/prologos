...
metadata hash. Recognized keys include =:where=, =:doc=, =:examples=,
=:properties=, =:see-also=, =:pre=, =:post=, =:refines=. Unrecognized keys
are stored but not acted upon (forward-compatible).
