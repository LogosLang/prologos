- [Executive Summary](#org76ae453)
  - [Infrastructure Gap Analysis](#orgcd1fb01)
  - [Critical Path](#org69d5bf6)
- [Phase 1: Lattice Trait + Standard Instances](#org751d1f2)
  - [1.1 Goal](#org1d1831f)
  - [1.2 The `Lattice` Trait](#orgaf9e2c6)
  - [1.3 Standard Lattice Instances](#org71250af)
    - [1.3.1 `FlatLattice A` — Three-Point Lattice](#org00f3416)
    - [1.3.2 `SetLattice A` — Powerset Lattice (Set Union)](#orgd6ede9d)
    - [1.3.3 `MapLattice K V` — Pointwise Map Lattice](#org02e98d0)
    - [1.3.4 `IntervalLattice` — Numeric Intervals](#orgd76a15c)
    - [1.3.5 `BoolLattice` — Two-Point Lattice](#org05a2b6e)
  - [1.4 Racket-Level Implementation](#orgdbe3f9e)
  - [1.5 `champ-insert-join` — Racket-Level Helper](#orgc36d7ff)
  - [1.6 New Files](#orgb470643)
  - [1.7 Tests (~25)](#org48f8d0c)
  - [1.8 Dependencies](#orgab3e17d)
- [Phase 2: Persistent Propagator Network](#org94eba4a)
  - [2.1 Goal](#org5fbf840)
  - [2.2 Architecture](#org3a12354)
  - [2.3 Core Data Structures (All Persistent)](#org8a134f8)
    - [2.3.1 Identity Types](#org65c0467)
    - [2.3.2 `prop-cell` — Propagator Cell (Immutable)](#org09c8bb1)
    - [2.3.3 `propagator` — Monotone Function (Immutable)](#org4f78cb5)
    - [2.3.4 `prop-network` — The Network as Value](#orge537d5e)
  - [2.4 Pure Operations](#orga53d14d)
  - [2.5 Concrete `fire-fn` Example: Adder Propagator](#orge979720)
  - [2.6 `run-to-quiescence` — Pure Loop](#org1104060)
  - [2.7 Contradiction Handling (Per-Cell `contradicts?` Predicate)](#orgd8d9add)
  - [2.8 LVars Are Subsumed by Cells](#orgc8d59df)
  - [2.9 AST Nodes (~12)](#org4bdd748)
  - [2.10 New/Modified Files](#orgb17dd3c)
  - [2.11 Tests (~60)](#org9447dd6)
  - [2.12 Dependencies](#orgb7b784a)
- [Phase 2.5: BSP Parallel Execution ✅](#org2fdb6b0)
  - [2.5.1 Goal](#org220f33c)
  - [2.5.2 BSP Scheduler (Jacobi Iteration)](#orgc30219a)
  - [2.5.3 Threshold Propagators](#org4bbb28f)
  - [2.5.4 Parallel Executor](#orged22b36)
  - [2.5.5 Implications for Later Phases](#orgdd8d294)
  - [2.5.6 New Functions](#orge4ea40c)
  - [2.5.7 Files and Tests](#orge421558)
  - [2.5.8 Key Design Decisions](#orge4441c2)
- [Phase 3: PropNetwork as Prologos Type](#orgad08b5f)
  - [3.1 Goal](#org090c76d)
  - [3.2 Why a Separate Phase](#org8182912)
  - [3.3 Type Signatures](#org947fad2)
  - [3.4 LVar Operations as Library Functions](#orgf0a1cf9)
  - [3.5 AST Nodes (12)](#org5a621f4)
  - [3.6 New/Modified Files](#org604fce7)
  - [3.7 Tests (~50)](#org0cbd6be)
  - [3.8 Dependencies](#orgf51904a)
- [Phase 4: UnionFind — Persistent Disjoint Sets](#orga17fedb)
  - [4.1 Goal](#org474193d)
  - [4.2 Design](#org61869e1)
  - [4.3 Key Properties](#org31b66c8)
  - [4.4 Integration with Logic Engine: UF vs Cell Division of Labor](#org7167719)
  - [4.5 AST Nodes (~6)](#orgb121c88)
  - [4.6 New/Modified Files](#org8e30748)
  - [4.7 Tests (~30)](#orgd0c0643)
  - [4.8 Dependencies](#org720114a)
- [Phase 5: Persistent ATMS Layer — Hypothetical Reasoning](#org0aefdda)
  - [5.1 Goal](#orgec6e7dd)
  - [5.2 Core Data Structures (All Persistent)](#orged05642)
    - [`assumption` — Hypothetical Premise](#org8a3c969)
    - [`supported-value` — Value + Justification](#org77d8c6f)
    - [`tms-cell` — Truth-Maintained Cell (Immutable)](#orga38463a)
    - [`atms` — The Persistent ATMS](#orga5916d4)
  - [5.3 Pure Operations](#org41b57ca)
  - [5.4 The `amb` Operator (Pure)](#org294fdcf)
  - [5.5 Two-Tier Mode: Lazy ATMS Activation](#org9f33ef5)
  - [5.6 Contradiction Handler (Dependency-Directed Backtracking)](#orge9f1a8d)
  - [5.7 Answer Collection (Pure)](#org70cbde2)
  - [5.8 BSP Integration: Parallel Worldview Exploration](#org68f65e3)
  - [5.9 AST Nodes (~10)](#orgab7d7c9)
  - [5.10 New/Modified Files](#org16a56a8)
  - [5.11 Tests (~50)](#orgcfa92fd)
  - [5.12 Dependencies](#org0753a16)
- [Phase 6: Tabling — SLG-Style Memoization](#org7fe57f5)
  - [6.1 Goal](#org4817941)
  - [6.2 Design (XSB-Style SLG Resolution)](#orgada5180)
  - [6.3 Table Lifecycle](#org6a97139)
  - [6.4 Core Data Structures (Persistent)](#orgf004d68)
  - [6.5 Lattice Answer Modes](#org4b492dc)
  - [6.6 Spec Metadata Integration](#org27c85da)
  - [6.7 BSP Integration: Parallel Table Evaluation](#orgd4e6fac)
  - [6.8 AST Nodes (~8)](#org9aa80ae)
  - [6.9 New/Modified Files](#org76f8258)
  - [6.10 Tests (~40)](#orgf62e751)
  - [6.11 Dependencies](#orgf6f9bf2)
- [Phase 7: Surface Syntax — `schema`, `defr`, `rel`, `solve`, `explain`, `solver`, `&>`, `||`, `|`](#org6a7a6cc)
  - [7.1 Goal](#orgbbdf107)
  - [7.2 Reader Changes](#orgdfcef13)
  - [7.3 Parser Changes](#orgd7acd1f)
    - [Multi-arity `|` dispatch](#org8cf15de)
    - [`||` fact blocks](#org09b4c43)
    - [`solve~/~explain` use `(...)` for goals](#org7e4da25)
  - [7.4 Elaboration](#orgc121868)
    - [7.4.1 `defr` Elaboration](#org52598b9)
    - [7.4.2 `solve` Elaboration (Functional-Relational Bridge)](#org166163e)
    - [7.4.3 `solve-with` Elaboration (Map Merge Override)](#orgf010f2d)
    - [7.4.4 `explain` Elaboration (Provenance-Bearing Bridge)](#orgd8b805b)
  - [7.5 Grammar Updates](#org416e056)
  - [7.6 Solver, Solve, and Explain — Unified Design](#orgab5fa97)
    - [7.6.1 Design Overview](#org9b13d06)
    - [7.6.2 The `solver` Top-Level Form](#org443e02a)
    - [7.6.3 The `Answer` Type](#orgb574889)
    - [7.6.4 Dispatch: `solve` / `explain` and `default-solver`](#org2a4039e)
    - [7.6.5 Map Merge Overrides with `{...}`](#org6b047ba)
    - [7.6.6 `default-solver` Shadowing](#org4587087)
    - [7.6.7 `solver` Elaboration](#orge1d7104)
    - [7.6.8 Default-Parallel Tradeoffs](#org9ad9dbe)
  - [7.7 Compile-Time Stratification Check](#orga2a97ce)
  - [7.8 AST Nodes (~26)](#org6641cc5)
    - [Relational Core (~14)](#org7984aea)
    - [Solve Family (~4)](#org5e23f54)
    - [Explain Family (~2)](#orga873258)
    - [Solver Config (~2)](#org4d8d311)
    - [Answer + Provenance Types (~2)](#org809bf5f)
    - [Control (~2)](#orgc894d60)
  - [7.9 New/Modified Files](#orge981d59)
  - [7.10 Tests (~110)](#org30f9772)
    - [Relations and Goals (~20)](#orgac0b002)
    - [Solve Family (~15)](#org0676ebf)
    - [Explain Family (~20)](#orga6da50f)
    - [Solver Config (~15)](#orgb6f2668)
    - [Stratification (~5)](#orgbe60769)
  - [7.11 Dependencies](#org149444f)
- [Phase Summary](#org284a0a8)
- [Interaction with Existing Infrastructure](#org0f053d5)
  - [Metavar System](#orgf0b526d)
  - [Trait System](#org32755b7)
  - [Spec Metadata](#org8980560)
  - [Warnings](#org2a350ed)
  - [QTT / Multiplicities](#org8618dfe)
  - [Collections](#orge7c6acb)
- [Appendix A: Resolution by Example — `ancestor` as Propagators](#org9a8f7c9)
  - [A.1 Source Program](#org27ef711)
  - [A.2 Step 1: Table Creation](#orgdedbb18)
  - [A.3 Step 2: Clause 1 → Producer Propagator](#orgf9bbd1c)
  - [A.4 Step 3: Clause 2 → Producer Propagator](#org5b7cee7)
  - [A.5 Step 4: Run to Quiescence](#org15b2dc9)
  - [A.6 Step 5: Answer Extraction](#orgce52eca)
- [Appendix B: End-to-End Query Walkthrough (All Three Layers)](#orgeea68e1)
  - [B.1 Source Program](#orgf16f42b)
  - [B.2 Compile-Time: Stratification Check](#org5043ca5)
  - [B.3 Runtime: Layer 1 — PropNetwork (Stratum 0)](#orgce0fcd3)
  - [B.4 Runtime: Layer 3 — Stratum Boundary](#org844ea34)
  - [B.5 Runtime: Layer 2 — ATMS (if needed)](#org55d2849)
  - [B.6 Summary: Which Layer Handles What](#org1a9a570)
- [Performance Expectations](#orgb60c023)
  - [Cost Model](#org2e055de)
  - [Benchmark Targets (to validate during implementation)](#orgfb3c088)
  - [When Performance Matters Most](#org268bfe2)
- [What This Design Does NOT Cover](#org35f6530)
  - [Elaborator Refactoring (Phase 1 of Research Doc)](#org7d74702)
  - [Galois Connections / Domain Embeddings (Phase 6 of Research Doc)](#org025ae26)
  - [Full Stratified Evaluation Runtime (Phase 4 of Research Doc)](#org29f212a)
  - [CRDTs / Distributed Logic](#org91034d5)
  - [QuickCheck / Property Testing](#orgc9a38af)
- [Architectural Decision: Persistent Networks](#org202416b)
  - [The Problem with Mutable Propagator Networks](#org435bde8)
  - [The Persistent Solution](#orgdb9c282)
  - [LVar Elimination](#org17fd9f1)
- [Key Lessons from Prior Work](#orgfce0a3e)
- [References](#orgb9cf459)
  - [Phase 1 (Lattice)](#org0ad1b97)
  - [Phase 2 (Propagators)](#org92aa7a7)
  - [Phase 3 (LVars)](#org8733dee)
  - [Phase 4 (UnionFind)](#org8a6619c)
  - [Phase 5 (ATMS)](#org7354afc)
  - [Phase 6 (Tabling)](#org1e1424b)
  - [Phase 7 (Surface)](#org59280d0)
...
| `expr-clause`        | goals                  | Single rule clause (&> &hellip;)          |
| `expr-fact-block`    | rows                   | Ground fact block (&vert;&vert; &hellip;) |
...
-   Sexp-mode: defr with explicit (defr &hellip;) form
...
-   Anonymous relation: (rel [?x ?y] &> &hellip;)
