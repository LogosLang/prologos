...
| 5 | ATMS struct dissolution + compound cells + consumer migration | ✅ | 13 commits. Behavioral parity (4 migrated test files) + architecture-validating (19 tests: compound decisions bitmask, worldview projection chain, compound commitments isolation, fire-once, end-to-end solver-state→compound→projection). |
