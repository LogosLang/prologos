...
| 4 | The payoff A/B (the chartered curve-turn measurement) | ✅ | iter 32: verdict — the curve has NOT turned (blanket ingestion +130ms standing overhead; memo marginal ~0 on repeats, PROVEN); two corpus premises falsified; the named lever = SELECTIVE ingestion (PIR §15) |
