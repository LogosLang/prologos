...
|-------+-----------+--------+--------+-------|
| AD-A | A0: =proc-recv= binding preservation | NOT STARTED | | Add =binding= field to =proc-recv= (14-file pass-through) |
| AD-A | A1: Effect Position Lattice | NOT STARTED | | =effect-position.rkt= |
| AD-A | A2: Effect Descriptor Type | NOT STARTED | | Extends =effect-position.rkt= |
