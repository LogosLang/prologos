...
| **X.close** | Bench matrix · DEFERRED triage · doc-truth sweep · memory fold · **Stage-5 PIR** | ✅ | Bench matrix `tier1-3` (counters + interleaved wall + the SUB.3a re-measure that COMPLETED the retraction: +6.4% does not reproduce, −0.1/−0.4%) · doc-truth `3e7062b0` · DEFERRED triage `24b6ec94` + `dd285174` (11 entries) · adversarial gap audit acted on `dd285174` (POL.1 shipped, 2 over-claims of mine corrected, 3 stale docs retired) · **PIR [`2026-07-25_REL_T1_PIR.md`](2026-07-25_REL_T1_PIR.md)** |
