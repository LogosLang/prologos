...
| **S2.e-iv** 🔄 | Retire 3 meta-store parameters + 3 champ-box parameters + 4 champ-fallback functions + clean meta-domain-info entries (`'champ-fallback`, `'legacy-fn`) | -150-250 deletion | **SPLIT into 3 sub-phases** per implementation audit (Category A/B/C divergent complexity): S2.e-iv-a champ-box status migration ✅ commit `85e9ad8b` (Category B; +86 / -117 LoC); S2.e-iv-b champ-fallback + legacy-fn cleanup ✅ commit `6efb709e` (Category C; +54 / -150 LoC); S2.e-iv-c meta-store retirement + 169-test-file surgery ⬜ (Category A) |
