...
| **N5** | Refinement substrate (function-level) — **mini-design §9c** (@d carrier = NOMINAL Sign-backed; 8-elem Sign + transfer + decomposed subsumption; migrate 5 refined types) | N0 ✅ (gate cleared) | 🔄 N5a ✅ (`d73335d7`), N5b ✅ (`b76045a7`), N5c ✅ (`5c022fe3`); **N5d+N5e MERGED → N5de** (coupling — see §9c); N5de/N5f pending |
