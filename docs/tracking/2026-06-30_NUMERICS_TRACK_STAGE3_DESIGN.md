...
| **N3** | `Float` primitive — new rank family (sub-phases N3a–g; see §9) | N1 ✅ | 🔄 **N3a** ✅ (`b963eff1`) + **N3b** arithmetic/compare ops + `float-impl.rkt` ✅ (`db816e65`; 15 files; `tests/test-float-ops.rkt`; suite 8427); N3c–g pending |
