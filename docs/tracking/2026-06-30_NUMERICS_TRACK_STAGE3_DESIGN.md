...
| **N3** | `Float` primitive — new rank family (sub-phases N3a–g; see §9) | N1 ✅ | 🔄 **N3a (type+value core) ✅** (12 files; `tests/test-float-core.rkt`); N3b–g pending |
