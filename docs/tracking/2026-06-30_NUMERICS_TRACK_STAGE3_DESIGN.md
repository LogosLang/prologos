...
| **N3** | `Float` primitive — new rank family (sub-phases N3a–g; see §9) | N1 ✅ | 🔄 **N3a** ✅ + **N3b** ✅ (`db816e65`) + **N3c** literals f/f32/f64 ✅ (`d90a8245`; 5 files; `tests/test-float-literal.rkt`; suite 8431; **full L3 Float compute unblocked**); N3d–g pending |
