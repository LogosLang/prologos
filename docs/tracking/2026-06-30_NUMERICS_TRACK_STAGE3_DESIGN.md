...
| **N5** | Refinement substrate (function-level) — **mini-design §9c** (@d carrier = NOMINAL Sign-backed; 8-elem Sign + transfer + decomposed subsumption; migrate 5 refined types) | N0 ✅ (gate cleared) | 🔄 N5a ✅ (`d73335d7`), N5b ✅ (`b76045a7`), N5c ✅ (`5c022fe3`); **N5de ✅ (`479e5227`)** — erasure + decomposed subsumption + sign-arith on all 3 typing stages (infer/inferQ/**on-network**) + qtt mixed-operand; **N5f** (classifier fix §8a-2) pending |
