...
| **N6** | Ergonomics capstone — **mini-design §9d** (owner usage-feedback decision set, 2026-07-01): N6a warnings ⬜ · N6b literal scheme (`pNN`, Posit32 default, `~` removal) ⬜ · N6c display (sigil-free posits, Rat→fractions) ⬜ · N6d `to-X` family + Float trait instances ⬜ · N6e first-class ops ⬜ · N6f reconciliation (vision/roadmap/audit/book/From→TryFrom/N3g) ⬜ | N3–N5, Q11 | 🔄 §9d captured; N6a next |
