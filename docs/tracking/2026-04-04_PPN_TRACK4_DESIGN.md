...
| 2 | Typing rules as DPO rewrite rules | 🔄 | **2a** ✅ struct+registry+dispatch (`bca522f5`). **2b** ✅ 12 literal+universe (`08402ded`). **2c** ✅ bvar+fvar (`fae47058`). **2d** ✅ lam+Pi+Sigma (`605f4356`). 2e: app/tensor pending. |
