...
| 2 | IN-fragment rule track — interior LADDERED per D.2 §5 (2026-06-10): Phase 0 effect-safety guard (BLOCKING) → arithmetic seed (~12-20 ops) → δ → guarded β | 🔄 | [D (opening)](2026-06-10_PREDUCE_TRACK2_DESIGN.md) | — | EXIT CRITERION (owner-bound): not done until the guard passes AND guarded β fires AND PRN §2 confirmation recorded. Design doc MUST open with the HVM2 benchmark-posture decision (deferred 2026-06-10 with this guard). |
