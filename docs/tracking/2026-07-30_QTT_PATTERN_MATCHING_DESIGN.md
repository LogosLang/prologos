...
**Status**: P1 ✅ · P2 ✅ · P3 ✅ · P4 ✅ · P5 ✅ · P6 ✅ · P7 ✅ · X.close ✅ — **COMPLETE**. Created
...
| a linear dropped/double-freed inside an unanalysable branch | **type-checked clean, and ran** | refused, naming what cannot be decided |
| a linear captured by a repeatedly-applied function | counted **once**, however many times consumed | ω-scaled (9 nodes) |
| a linear consumed inside `J`'s base | counted **zero** times | counted |

Suite 9418 → 9483, 475 files, 0 failures throughout. Zero stdlib fallout.
...
| P6 | Close the Church-fold agreement hole (a real leak + double-free type-checked clean) | ✅ | `e5810cfe` — suite 9477/475/0 |
| P7 | ω-scale repeatedly-applied function args — 9 nodes, 28 sites, both twins; J's dropped base folded in | ✅ | `63dea0b6` — suite 9483/475/0 |
