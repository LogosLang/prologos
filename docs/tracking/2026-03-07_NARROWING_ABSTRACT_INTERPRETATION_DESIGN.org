...
|-------+-----------+-------------------------------------------+-------------+------------+-------|
| 1 | 1a | Definitional Tree Extraction | COMPLETE | =99e56a8= | =definitional-tree.rkt= ~200 lines, 39 tests |
| 1 | 1a+ | Pattern defn → DT integration | COMPLETE | =3bd6cc8= | Verified: pattern clauses produce correct DTs |
| 1 | 1b | Term Lattice | COMPLETE | | =term-lattice.rkt= 226 lines, 49 tests |
| 1 | 1c | Narrowing Propagator | NOT STARTED | | =narrowing.rkt= ~300 lines |
| 1 | 1d | Solver Integration | NOT STARTED | | =relations.rkt=, =solver.rkt= ~200 lines |
| 1 | 1e | WS-Mode Syntax (=?= variables, ==\==) | NOT STARTED | | parser, WS reader ~100 lines |
| 2 | 2a | Interval Abstract Domain | NOT STARTED | | ~530 lines, ~105 tests |
| 2 | 2a+ | Length-Interval Domain (List/String) | NOT STARTED | | Future enhancement |
| 2 | 2b | Size-Based Termination (LJBA) | NOT STARTED | | ~390 lines, ~80 tests |
| 2 | 2c | Critical Pair / Confluence Analysis | NOT STARTED | | ~350 lines, ~65 tests; lazy for IS functions |
| 3 | 3a | 0-CFA Auto-Defunctionalization | NOT STARTED | | ~460 lines, ~70 tests; demand-driven |
| 3 | 3b | Configurable Search Heuristics | NOT STARTED | | ~590 lines, ~105 tests |
| 3 | 3c | Global Constraints + BB Optimization | NOT STARTED | | ~510 lines, ~95 tests |
