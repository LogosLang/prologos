...
| 1 | 1c | Narrowing Propagator | ✅ | | =narrowing.rkt= 275 lines, 31 tests |
| 1 | 1d | Solver Integration | ⬚ | | =relations.rkt=, =solver.rkt= ~200 lines |
| 1 | 1e | WS-Mode Syntax (=?= variables, ==\==) | ⬚ | | parser, WS reader ~100 lines |
| 2 | 2a | Interval Abstract Domain | ⬚ | | ~530 lines, ~105 tests |
| 2 | 2a+ | Length-Interval Domain (List/String) | ⬚ | | Future enhancement |
| 2 | 2b | Size-Based Termination (LJBA) | ⬚ | | ~390 lines, ~80 tests |
| 2 | 2c | Critical Pair / Confluence Analysis | ⬚ | | ~350 lines, ~65 tests; lazy for IS functions |
| 3 | 3a | 0-CFA Auto-Defunctionalization | ⬚ | | ~460 lines, ~70 tests; demand-driven |
| 3 | 3b | Configurable Search Heuristics | ⬚ | | ~590 lines, ~105 tests |
