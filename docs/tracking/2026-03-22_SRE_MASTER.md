...
| 2D | **Rewrite Relation** — 4th SRE relation, DPO spans on network | ✅ | [Design](2026-04-03_SRE_TRACK2D_DESIGN.md) | [PIR](2026-04-03_SRE_TRACK2D_PIR.md) | 11/13 rules lifted to SRE spans (5 simple, 5 fold, 1 tree). DPO spans, pattern-desc (Grammar Form target), PUnify holes, fold/tree combinators, propagator factory, critical pair analysis (0 pairs, strongly confluent). Form tags as first-class ctor-descs. Provides concrete DPO/HR examples for Grammar Form R&D. |
