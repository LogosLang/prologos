...
| 3 | Trait Resolution-on-SRE — impl lookup via structural matching | ⬜ | — | — | Needs Track 1 ✅ (subtyping). Subsumes PM 8E resolution state. May benefit from Track 2H (subtype lattice properties inform resolution strategy). |
