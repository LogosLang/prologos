...
| 2G | **Algebraic Domain Awareness** — domain algebraic class declarations | ⬜ | — | — | **From Algebraic Embeddings research**: Domains declare algebraic class (Heyting, residuated, Boolean, quantale). Infrastructure derives capabilities automatically. Extension point from Track 2F. [Research](../research/2026-03-28_ALGEBRAIC_EMBEDDINGS_LATTICES.md). Connects to UCS series. |
