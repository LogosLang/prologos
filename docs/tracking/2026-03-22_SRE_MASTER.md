...
| 2D | Rewrite Relation — lift PPN 2-3 rewrites onto SRE | ⬜ | — | — | [Stage 2 Audit](2026-04-03_SRE_TRACK2D_STAGE2_AUDIT.md). 12 rewrite rules in surface-rewrite.rkt: 6 simple (directly liftable), 3 recursive (need fold combinator), 1 dynamic (defmacro), 2 context-dependent (Track 4). Pipeline IS the monotone shell. Key gap: implicit interface K. Provides concrete DPO/HR examples for Grammar Form R&D. [Research note](../research/2026-03-26_TREE_REWRITING_AS_STRUCTURAL_UNIFICATION.md). |
