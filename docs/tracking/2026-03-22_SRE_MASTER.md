...
| 5 | Pattern Compilation-on-SRE — scrutinee decomposition + NF-Narrowing | ⬜ | — | — | GADT path via unified narrowing. Independent of PM tracks. **Adhesive DPO**: pattern compilation is DPO rewriting on match trees. Compilation order doesn't affect decision tree (adhesive confluence). See [Adhesive Categories research](../research/2026-04-03_ADHESIVE_CATEGORIES_PARSE_TREES.md) §6. |
