...
| 2F | **Algebraic Foundation** — endomorphism ring decomposition as data | ⬜ | — | — | **From PTF Track 1**: Make the SRE's algebraic structure self-documenting. Kind-variance table as single source of truth. Unify duality's `component-lattices` dispatch with variance mechanism. Nomenclature cleanup. [PTF Track 1 Design §Phase 3](2026-03-28_PTF_TRACK1_DESIGN.md). [Module Theory](../research/2026-03-28_MODULE_THEORY_LATTICES.md) §3. **FOUNDATIONAL** — should precede Tracks 3-7 (all consume the relation engine). |
