...
|-------+-----------+-------------------------------------------+-------------+--------+-------|
| 1 | 1a | Definitional Tree Extraction | NOT STARTED | | Prereq for all Phase 2-3 |
| 1 | 1b | Term Lattice | NOT STARTED | | |
| 1 | 1c | Narrowing Propagator | NOT STARTED | | |
| 1 | 1d | Solver Integration | NOT STARTED | | |
| 1 | 1e | WS-Mode Syntax (=?= variables, ==\==) | NOT STARTED | | |
