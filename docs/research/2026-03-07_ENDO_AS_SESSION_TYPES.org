...
and message number validity --- that session types can verify statically.
These properties are currently enforced by runtime checks, code ordering,
and developer discipline. Session types would move them to compile-time
guarantees.
