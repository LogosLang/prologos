...
(define source-deps
  (hasheq
   ...
   'effect-executor.rkt            '(effect-ordering.rkt effect-position.rkt io-bridge.rkt pretty-print.rkt processes.rkt propagator.rkt sessions.rkt session-lattice.rkt session-runtime.rkt syntax.rkt)
   ...
   'global-constraints.rkt        '(interval-domain.rkt syntax.rkt)
   ...
   'narrowing.rkt                 '(bb-optimization.rkt cfa-analysis.rkt confluence-analysis.rkt definitional-tree.rkt global-constraints.rkt global-env.rkt interval-domain.rkt macros.rkt narrowing-abstract.rkt propagator.rkt search-heuristics.rkt syntax.rkt term-lattice.rkt termination-analysis.rkt)
   ...
   'posit-impl.rkt                '()
   'prelude.rkt                   '()
   'pretty-print.rkt              '(atms.rkt champ.rkt metavar-store.rkt prelude.rkt processes.rkt propagator.rkt rrb.rkt sessions.rkt syntax.rkt tabling.rkt union-find.rkt)
...
(define test-deps
  (hasheq
   ...
   (test-dep '(driver.rkt sessions.rkt elaborator.rkt macros.rkt) #t)
   'test-io-fs-01.rkt
   (test-dep '(driver.rkt io-ffi.rkt foreign.rkt) #t)
   'test-io-session-01.rkt
   (test-dep '(driver.rkt sessions.rkt) #t)
   'test-io-session-02.rkt
   (test-dep '(session-runtime.rkt io-bridge.rkt sessions.rkt) #f)
   ...
   (test-dep '(champ.rkt driver.rkt elaborator-network.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt mult-lattice.rkt namespace.rkt prelude.rkt propagator.rkt syntax.rkt type-lattice.rkt) #t)
   ...
   (test-dep '(bb-optimization.rkt definitional-tree.rkt driver.rkt errors.rkt global-constraints.rkt global-env.rkt interval-domain.rkt macros.rkt metavar-store.rkt narrowing.rkt namespace.rkt prelude.rkt solver.rkt syntax.rkt trait-resolution.rkt) #t)
   'test-cfa-analysis-01.rkt
   (test-dep '(bb-optimization.rkt cfa-analysis.rkt definitional-tree.rkt driver.rkt errors.rkt global-constraints.rkt global-env.rkt macros.rkt metavar-store.rkt narrowing.rkt namespace.rkt prelude.rkt search-heuristics.rkt solver.rkt syntax.rkt trait-resolution.rkt) #t)
   ...
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt reader.rkt reduction.rkt source-location.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt typing-core.rkt) #t)
   'test-pattern-defn-02.rkt
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt reader.rkt reduction.rkt source-location.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt typing-core.rkt) #t)
   'test-unified-match-01.rkt
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt reader.rkt reduction.rkt source-location.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt typing-core.rkt) #t)
   'test-int-patterns-01.rkt
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt) #t)
   'test-guards-01.rkt
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt) #t)
   'test-cond-01.rkt
   (test-dep '(driver.rkt elaborator.rkt errors.rkt global-env.rkt macros.rkt metavar-store.rkt multi-dispatch.rkt namespace.rkt parser.rkt prelude.rkt pretty-print.rkt surface-syntax.rkt syntax.rkt trait-resolution.rkt) #t)
   ...
   (test-dep '(constraint-cell.rkt constraint-propagators.rkt driver.rkt global-env.rkt macros.rkt metavar-store.rkt namespace.rkt prelude.rkt reduction.rkt syntax.rkt) #t)
   'test-hasmethod-01.rkt
   (test-dep '(driver.rkt elaborator.rkt expander.rkt global-env.rkt macros.rkt metavar-store.rkt namespace.rkt prelude.rkt syntax.rkt trait-resolution.rkt zonk.rkt) #t)
   ...
   (test-dep '(metavar-store.rkt prelude.rkt syntax.rkt unify.rkt) #f)
   'test-unify.rkt
