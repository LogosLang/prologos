...
(test-case "auto-export: explicit provide overrides auto-exports"
  ...
  (check-exn
   ...
   (lambda ()
     (run-ns-pair
       "(ns test.override.mod-a)\n(provide pub-fn)\n(defn pub-fn : (-> Nat Nat) [n] (inc n))\n(defn hidden-fn : (-> Nat Nat) [n] (inc (inc n)))"
