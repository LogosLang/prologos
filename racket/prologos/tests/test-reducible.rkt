...
(require (prologos::core::list   :refer (list-reducible List--Buildable--dict)))
(require (prologos::core::pvec   :refer (pvec-reducible PVec--Buildable--dict)))
(require (prologos::core::set    :refer (set-reducible Set--Buildable--dict)))
(require (prologos::core::lseq   :refer (lseq-reducible)))
