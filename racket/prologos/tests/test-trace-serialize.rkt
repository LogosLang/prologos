...
(test-case "serialize-network-topology: empty network"
  ...
  (check-equal? (hash-ref (hash-ref js 'stats) 'totalCells) 20)  ;; PPN 4C 3C.b.1: 20 well-known cells (0-17 as before + 18=contradicted-branch-aids, 19=union-derivation-chains)
...
(test-case "serialize-network-topology: network with cells and propagator"
  ...
  (check-equal? (hash-ref (hash-ref js 'stats) 'totalCells) 22)  ;; PPN 4C 3C.b.1: 20 well-known + 2 user (cid-a, cid-b)
