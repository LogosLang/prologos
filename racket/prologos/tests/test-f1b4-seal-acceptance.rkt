...
;;;
;;; CIU Track 6 F1b.4 — WS-level acceptance gate (the D22 seal).
;;;
;;; Runs the F1b.4 seal acceptance file through process-file and verifies its
...
(define-runtime-path acceptance-file
  "../examples/2026-07-17-ciu-t6-f1b4-seal.prologos")
