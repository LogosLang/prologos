...
(test-case "Float op typing"
  ...
  ;; width-mismatch / cross-family is ill-typed (no implicit Posit/Float join here)
  (check-equal? (tc:infer ctx-empty (expr-f64-add (expr-float32 1.0) (expr-float64 2.0))) (expr-error)
                "mixed f32/f64 is ill-typed")
