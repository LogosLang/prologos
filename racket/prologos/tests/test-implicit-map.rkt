...
;;;
;;; Tests for implicit map syntax: keyword-headed tails → $brace-params
;;;
;;; Indentation-based keyword blocks automatically desugar to map literals:
;;;   def m
;;;     :name "Alice"
;;;     :age 25N
;;; → def m {:name "Alice" :age 25N}
;;;
...
;; ========================================
;; B. Shared Fixture for E2E tests
;; ========================================
