...
(define preamble
  "(ns test)
(imports (prologos::core::arithmetic :refer (Add Add-add Sub Sub-sub Mul Mul-mul
                                             Div Div-div Neg Neg-neg Abs Abs-abs)))
(imports (prologos::core::algebra  :refer (plus minus times divide negate-fn abs-fn)))
")
