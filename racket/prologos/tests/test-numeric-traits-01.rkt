...
(test-case "add/nat-direct"
  (define r (run-ns-last (string-append
    "(ns t)\n"
    "(imports [prologos::core::arithmetic :refer [Add Add-add]])\n"
...
(test-case "sub/nat-direct"
  (define r (run-ns-last (string-append
    "(ns t)\n"
    "(imports [prologos::core::arithmetic :refer [Sub Sub-sub]])\n"
...
(test-case "mul/nat-direct"
  (define r (run-ns-last (string-append
    "(ns t)\n"
    "(imports [prologos::core::arithmetic :refer [Mul Mul-mul]])\n"
...
(test-case "abs/int-direct"
  (define r (run-ns-last (string-append
    "(ns t)\n"
    "(imports [prologos::core::arithmetic :refer [Abs Abs-abs]])\n"
