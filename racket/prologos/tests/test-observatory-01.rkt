...
(test-case "build-cell-metas-from-network: builds meta for each cell"
  ...
  (check-equal? (cell-meta-label meta-a) "cell-17")  ;; PPN 4C 3A.0: cell-ids 0-16 pre-allocated (0-5 well-known, 6-9 topology, 10 classify-inhabit, 11=fuel, 12=fuel-budget, 13=retraction-stratum, 14=resolution-stratum, 15=fork-on-union-request, 16=fork-contradiction-request)
  (check-equal? (cell-meta-label meta-b) "cell-18")
  (check-equal? (cell-meta-label meta-c) "cell-19"))
