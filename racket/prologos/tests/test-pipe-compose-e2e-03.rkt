...
;;;
;;; E2E Tests for Phase 2c: Compose (>>) Operator — Sexp Mode
;;;
;;; Split from original test-pipe-compose-e2e-01.rkt:
;;; - test-pipe-compose-e2e-01.rkt: Pipe E2E tests (sexp mode)
;;; - test-pipe-compose-e2e-02.rkt: WS mode E2E tests (separate)
;;; - THIS FILE: Compose E2E tests (sexp mode) — 4 tests
;;;
...
;; ========================================
;; E. WS Mode E2E (placeholder — tests in -02)
;; ========================================
